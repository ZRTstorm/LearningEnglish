...
public class PronunciationService {
    ...
    private static final Map<String, String> phonemeFeedbackMap = Map.ofEntries(
            ...
            Map.entry("ŋ", "'ŋ'는 'ng'처럼 코 뒤에서 울리는 소리예요 (예: sing)"),
            Map.entry("l", "'l'는 혀끝을 윗잇몸에 붙이고 부드럽게 소리내요!"),
            Map.entry("r", "'r'는 혀를 말아올리고 입을 둥글게 만들어 부드럽게 소리내요!"),
            Map.entry("j", "'j'는 '이'로 시작하는 소리처럼 발음돼요 (예: yes)"),
            Map.entry("w", "'w'는 입술을 둥글게 오므리고 빠르게 '우'처럼 발음돼요!"),
            Map.entry("iː", "'iː'는 길게 늘이는 '이' 소리예요 (예: see)"),
            Map.entry("ɪ", "'ɪ'는 짧은 '이' 소리예요 (예: bit)"),
            Map.entry("e", "'e'는 입을 살짝 벌리고 짧게 '에'처럼 발음해요 (예: bed)"),
            Map.entry("æ", "'æ'는 입을 크게 벌리고 '애'처럼 발음해요 (예: cat)"),
            Map.entry("ʌ", "'ʌ'는 중간 정도 입을 벌리고 '어'처럼 발음해요 (예: cup)"),
            Map.entry("ɑː", "'ɑː'는 깊고 길게 '아'처럼 발음돼요 (예: car)"),
            Map.entry("ɒ", "'ɒ'는 짧은 '오'처럼 발음돼요 (예: hot)"),
            Map.entry("ɔː", "'ɔː'는 길게 '오'처럼 발음돼요 (예: saw)"),
            Map.entry("ʊ", "'ʊ'는 짧은 '우'처럼 발음돼요 (예: book)"),
            Map.entry("uː", "'uː'는 길게 '우'처럼 발음돼요 (예: food)"),
            Map.entry("ə", "'ə'는 힘을 주지 않고 중성적으로 발음하는 '어' 소리예요 (예: about)"),
            Map.entry("eɪ", "'eɪ'는 '에'에서 '이'로 미끄러지듯 나는 소리예요 (예: say)"),
            Map.entry("aɪ", "'aɪ'는 '아'에서 '이'로 연결되는 소리예요 (예: my)"),
            Map.entry("ɔɪ", "'ɔɪ'는 '오'에서 '이'로 이어지는 소리예요 (예: boy)"),
            Map.entry("aʊ", "'aʊ'는 '아'에서 '우'로 넘어가는 소리예요 (예: now)"),
            Map.entry("əʊ", "'əʊ'는 '어'에서 '우'로 이어지는 소리예요 (예: go)"),
            Map.entry("ɪə", "'ɪə'는 '이'와 '어'가 이어지는 소리예요 (예: ear)"),
            Map.entry("eə", "'eə'는 '에'에서 '어'로 흐르는 소리예요 (예: hair)"),
            Map.entry("ʊə", "'ʊə'는 '우'에서 '어'로 흐르는 소리예요 (예: sure)")
    );
